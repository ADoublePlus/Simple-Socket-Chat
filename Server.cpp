...
int main()
{
    ...
    hint.sin_addr.S_un.S_addr = INADDR_ANY; // inet_pton may also be used

    bind(listening, (sockaddr*)&hint, sizeof(hint));

    // Inform winsock the socket is ready for listening
    ...
    // This will be altered by the \quit command
    bool running = true;
    ...
    while (running)
    {
        ...
        // E.g. You have a server and its master file descriptor set contains 5 items;
